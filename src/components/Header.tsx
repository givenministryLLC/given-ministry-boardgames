            ...
            <div className="max-w-7xl mx-auto px-4">
                <div className="flex justify-between items-center h-16">
                    ...
                    <Link href="/" className="flex items-center space-x-2 group">
                        <div className="bg-primary p-2 rounded-lg transform group-hover:scale-110 transition-transform duration-200 shadow-md">
                    ...
                    <div className="flex items-center space-x-4">
                        <Link
                            href="/cart"
                            className="relative group flex items-center space-x-2 text-deep-brown hover:text-primary transition-all duration-200 hover:scale-105"
                        >
                            <div className="relative">
                                <ShoppingCart className="w-6 h-6 group-hover:animate-bounce" />
                                {/* Dynamic cart badge */}
                                {cartCount > 0 && (
                                    <span className="absolute -top-2 -right-2 bg-primary text-warm-cream text-xs rounded-full w-5 h-5 flex items-center justify-center font-medium">
                        ...
                        <button
                            ...
                            className="md:hidden text-deep-brown hover:text-primary p-2 rounded-lg hover:bg-sage-green/10 transition-all duration-200"
                        >
